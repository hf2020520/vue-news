<template>
	<div class="banner">
        <ul class="clearfix">
            <li><img src="static/img/img_1.jpg" alt=""/>
            	<div class="text-box">
                	<h2>还可以降低首付款健身房11111</h2>
                    <p>刘德华11 / 文</p>
                </div>
            </li>
            <li><img src="static/img/img_2.jpg" alt=""/>
            	<div class="text-box">
                	<h2>还可以降低首付款健身房2222</h2>
                    <p>刘德华22 / 文</p>
                </div>
            </li>
            <li><img src="static/img/img_3.jpg" alt=""/>
            	<div class="text-box">
...
<style scoped>
.clearfix{position: relative;left: -.7rem;}
...
.banner ul li{width:6.5rem;float:left;position: relative;}
.banner ul li img{width:100%; display:block;}
.banner ul li .text-box{text-align: center;width:5.8rem; padding:0 0.3rem;height:.7rem; position:absolute; left:0; bottom:0; color:#fff; background:rgba(0,0,0,0.5);}
