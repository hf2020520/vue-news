...
<style scoped>
	...
	.content{max-width:6.4rem; margin:0 auto;margin-top: -30%;}
	.content .fhbtn{ padding-top:0.27rem;}
	.content .fhbtn a{ display:block;width:0.23rem;height:0.25rem; background-size:100%; margin-left:0.3rem;}
	.content h1{width:2.18rem;height:1.35rem;  background-size:100%; margin:0 auto; margin-top:1.22rem;}
	...
	.content ul{width:5.78rem;height:3rem; border:1px solid #e5e7e8; background:#fff; margin:0 auto; margin-top:0.68rem;}
	.content ul li{height:0.95rem; position:relative; margin-left: -25px;}
